...
+ Souhait de pouvoir mobiliser une grille de carreaux de la taille de son choix ;+ Souhait de pouvoir **imposer une zone de lissage** (pas de taux de pauvreté dans la mer !) ;
+ Souhait de faire du « lissage quantile » ;
+ Souhait d'algorithmes rapides.
