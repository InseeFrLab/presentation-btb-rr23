...
## 3 manières de cartographier les données géographiques
...
1. **Le territoire** : une partition irrégulière de l'espace. Plusieurs difficultés : essentiellement l'effet **MAUP** (*Modifiable areal unit problem*) ;</br></br></br>

2. **La grille carroyée** : un découpage régulier de l'espace en carreaux. Par construction, ces données peuvent être très erratiques ; </br></br></br>
...
Mais pour l'analyse urbaine :

+ Besoin de lissage **conservatif** ;
+ Besoin de pouvoir **imposer une zone de lissage** (pas de taux de pauvreté dans la mer !) ;
+ Besoin de faire du « lissage quantile » ;
+ Besoin d'algorithmes rapides.
...
**Les hypothèses de lissage**
  ...
  + Une **fonction kernel** indiquant la manière d'approcher le voisinage ;
