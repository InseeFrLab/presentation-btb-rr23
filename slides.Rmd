...
➡️ Généralement, **Transformée de Fourier Rapide**.

Pas adapté à la gestion des **effets de bord** en analyse urbaine
...
+ Lissage quantile (plus robuste, distributions lissées)
+ Développé en C++ (`Rcpp`)
]
